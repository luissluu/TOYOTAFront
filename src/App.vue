          ...
          <div class="flex flex-col items-center flex-1 space-y-6">
              ...
              <nav class="flex flex-col items-center space-y-6">
                  ...
                  <router-link to="/Servicios" class="p-3 transition-all duration-300 rounded-lg group hover:bg-white/10" :class="{ 'bg-white/10': $route.path === '/Servicios' }">
                      <svg class="w-5 h-5 transition-colors duration-300" :class="{ 'text-blue-500': $route.path === '/Servicios', 'text-gray-400 group-hover:text-blue-500': $route.path !== '/Servicios' }" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <router-link to="/Historial" class="p-3 transition-all duration-300 rounded-lg group hover:bg-white/10" :class="{ 'bg-white/10': $route.path === '/Historial' }">
                      <svg class="w-5 h-5 transition-colors duration-300" :class="{ 'text-blue-500': $route.path === '/Historial', 'text-gray-400 group-hover:text-blue-500': $route.path !== '/Historial' }" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
